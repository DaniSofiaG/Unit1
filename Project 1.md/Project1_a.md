...
## Proposed Solution and Rationale for proposed solution
#### What is the product?
...
MLA: “BNB - What Is BNB and What Is It Used For?” Binance, www.binance.com/en/bnb. Accessed 9 Oct. 2022.
...
|    7    |             code my first function for log-in along with class             |                                To understand how to create a function which goes back to a file reads it and validates inputs                                |     20 min    |         Sep 27         |     C     |
|    8    |                              Code my home menu                             |       To have a menu so that the validation of either registration or log-in can happen, taht way my client can select to create or access her account       |     30min     |         Sep 27         |     C     |
|    9    |        define the functions I will use for my project in my library        |                    Select functions I already have like colors, validating inputs, ending code in order to make my coding process smoother                   |     30 min    |         Sep 29         |  B and C  |
|    10   |            code my first function for log-in along with my class           |                                To understand how to create a function which goes back to a file reads it and validates inputs                                |               |                        |     C     |
|    11   |                       To create a registration system                      |                                                   To fulfill some of my clent's, Ms Sato, needs and wants.                                                   |     40min     |         Sep 30         |     C     |
|    12   |                                                                            |                                                                                                                                                              |               |                        |           |
|    13   |                           Code my functions menu                           |                                             To have a menu based on the sucdess criteria I previously decided on                                             |     30min     |         Sep 27         |     C     |
|    14   |                           Make my first flowchart                          |                                 To create a flowchart based on a section of my my code that is important to it and the task.                                 |     30min     |          Oct 1         |     B     |
|    15   |                      Add a description of Binance coin                     |                                 To add a descriptin that can me accesed in the Functions menu through the validation function                                |     10 min    |          Oct 2         |     C     |
|    16   |                                                                            |                                                                                                                                                              |               |                        |           |
|    17   |         Continue creating another function from the functions menu         |                                                To begin filling the requirements posed by my success criteria                                                |     30 min    |          Oct2          |     C     |
|    18   |                 Code it into my project with if functions                  |              To use the tools learned in class to incorporate functions, strings, if and while loops, etc in order to create a complete program              |     30 min    |          Oct 2         |     C     |
|    19   | Fill and create function corresponding to all options of my functions menu |                  To complete all the requirements from my success criteria and make functions needed for each option of the functions menu.                  |     3 days    |       Oct 2-Oct 5      |     C     |
|    20   |  Build a program using my functions and other tools to conbine everything  |              To use the tools learned in class to incorporate functions, strings, if and while loops, etc in order to create a complete program              |     1 day     |          Oct 6         |     C     |
|    21   |     Select and create flowcharts for another two sections of my program    |                                Two use my design ablilities to better understand my program and identify areas of improvement                                |  1 hr 30 min  |          Oct 6         |     B     |
|    22   |                                  Test code                                 |                                                Have several of my classmates test and give feedback to my code                                               |     30 min    |          Oct 7         |     B     |
|    23   |                               Revise and edit                              |           Edit and make improvements to my code like adding visual dividers for different sections of the code and clasifying sections with colors           |      1 hr     |          Oct 7         |     C     |
|    24   |     Write explanation to the sections I selected to make flowcharts on     |                                             To explain their importance to my program and the needs of my client                                             |     40 min    |          Oct 7         |     C     |
